...
function initCanvas() {
	...
	if (canvas.getContext) {
		...
		bgimg.src = './assets/bgimg.png';

		// make sure we get the value
		checkboxSfx_clicked();

		// force the sound assets to load before we continue
		new Audio('./assets/swoosh.ogg').load();
		new Audio('./assets/shot.ogg').load();
		new Audio('./assets/punch1.ogg').load();
		new Audio('./assets/punch2.ogg').load();
		new Audio('./assets/punch3.ogg').load();
		new Audio('./assets/punch4.ogg').load();
...
function playJumpSound() {
	if (sfxenabled)
		new Audio('./assets/swoosh.ogg').play();
}

// the jumping noise
function playDeathSound() {
	if (sfxenabled)
		new Audio('./assets/shot.ogg').play();
}
...
function playPunchSound() {
	if (sfxenabled) {
		...
		switch (num) {
			case 0:
				var a = new Audio('./assets/punch1.ogg');
				a.volume = 0.25;
				a.play();
				break;
			case 1:
				var a = new Audio('./assets/punch2.ogg');
				a.volume = 0.25;
				a.play();
				break;
			case 2:
				var a = new Audio('./assets/punch3.ogg');
				a.volume = 0.25;
				a.play();
				break;
			default:
				var a = new Audio('./assets/punch4.ogg');
				a.volume = 0.25;
				a.play();
				break;
		}
